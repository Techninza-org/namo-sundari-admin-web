...
export function DashboardNavbar({ isOpen, setIsOpen }) {
        ...
        <div className="flex items-center">
          ...
          {/* <Menu>
            ...
            <MenuList className="w-max border-0">
              ...
              <MenuItem className="flex items-center gap-4">
                <div className="grid h-9 w-9 place-items-center rounded-full bg-gradient-to-tr from-gray-800 to-gray-900">
